...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__subtitles__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__features_index__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__features_dragSubtitles_dragSubtitles__ = __webpack_require__(14);
...
document.addEventListener("DOMContentLoaded", async function () {
  const playerInstance = new __WEBPACK_IMPORTED_MODULE_1__player__["a" /* Player */]();
  const subtitlesInstance = new __WEBPACK_IMPORTED_MODULE_0__subtitles__["a" /* Subtitles */]();

  await Promise.all([playerInstance.setup('player'), subtitlesInstance.loadSubtitles('/subs.srt')]);

  const core = new __WEBPACK_IMPORTED_MODULE_2__core__["a" /* Core */](playerInstance, subtitlesInstance);
  const features = new __WEBPACK_IMPORTED_MODULE_3__features_index__["a" /* Features */](core, 'feature');

  features.addFeature('d', __WEBPACK_IMPORTED_MODULE_4__features_dragSubtitles_dragSubtitles__["a" /* DragSubtitles */]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_binarySearch__ = __webpack_require__(9);
...
class Subtitles {
  ...
  loadSubtitles(fileName) {
    return Object(__WEBPACK_IMPORTED_MODULE_0__utils_request__["a" /* getRequest */])(fileName).then(subtitlesParser).then(subtitles => {
      this.subtitles = subtitles;
    });
  }

  getIndexByTime(time) {
    return Object(__WEBPACK_IMPORTED_MODULE_1__utils_binarySearch__["a" /* binarySearch */])(this.subtitles, time, (sub, time) => {
      return time < sub.startTime ? 1 : time > sub.endTime ? -1 : 0;
    }, true);
  }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = Subtitles;
...
function binarySearch(haystack, needle, comparator, isLess) {
  let mid, cmp;
  let low = 0;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_plyr__ = __webpack_require__(11);
...
class Player {
  ...
  setup(playedId) {
    this.player = __WEBPACK_IMPORTED_MODULE_0_plyr__["setup"](document.getElementById(playedId))[0];
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_keycode__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_keycode___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_keycode__);



class Core {

  constructor(playerInstance, subtitlesInstance) {
...
Core.timeDiff = 70;
Core.repeatKeyCode = __WEBPACK_IMPORTED_MODULE_0_keycode__('r');
...
class Features {
  ...
  addFeature(keyName, featureClass) {
    Features.featuresKeyCodes[__WEBPACK_IMPORTED_MODULE_0_keycode__(keyName)] = new featureClass(this.coreInstance, this.container);
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_radnomizeArray__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__templates_word_handlebars__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__templates_word_handlebars___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__templates_word_handlebars__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__templates_block_handlebars__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__templates_block_handlebars___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__templates_block_handlebars__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__dragSubtitles_css__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__dragSubtitles_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__dragSubtitles_css__);
...
class DragSubtitles {
  ...
  startuem() {
    ...
    this.container.innerHTML = __WEBPACK_IMPORTED_MODULE_3__templates_block_handlebars___default()({
      content: Object(__WEBPACK_IMPORTED_MODULE_1__utils_radnomizeArray__["a" /* radomizeArray */])(words).map(word => __WEBPACK_IMPORTED_MODULE_2__templates_word_handlebars___default()({ word })).join('')
    });

    const wordsEl = document.getElementById('words');
    const wordsElChildNodes = wordsEl.childNodes;

    this.dragulaInstance = __WEBPACK_IMPORTED_MODULE_0_dragula__([wordsEl], {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = DragSubtitles;
...
var crossvent = __webpack_require__(23);
...
var ticky = __webpack_require__(19);
...
var customEvent = __webpack_require__(24);
var eventmap = __webpack_require__(25);
var doc = global.document;
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = radomizeArray;
function radomizeArray(array) {
